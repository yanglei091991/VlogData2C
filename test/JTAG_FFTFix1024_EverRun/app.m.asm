...
.opt
NOP;
BIU0.DM(A++,K++)->M[110];  //SHU0.T1 
BIU0.DM(A++,K++)->M[111];  //SHU0.T2
BIU0.DM(A++,K++)->M[112];  //SHU0.T3
BIU0.DM(A++,K++)->M[113];  //SHU1.T1
BIU0.DM(A++,K++)->M[114];  //SHU1.T2
BIU0.DM(A++,K++)->M[115];  //SHU1.T3
BIU0.DM(A++,K++)->M[116];  //EP0BIU0
BIU0.DM(A++,K++)->M[117];  //EP0BIU1
BIU0.DM(A++,K++)->M[118];  //EP0BIU2
BIU0.DM(A++,K++)->M[119];  //EP1BIU2
BIU0.DM(A++,K++)->M[120];  //EP1BIU0
BIU0.DM(A++,K++)->M[121];  //EP2BIU0
BIU0.DM(A++,K++)->M[122];  //EP2BIU2
